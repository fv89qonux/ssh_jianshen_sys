...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body  leftmargin="2" topmargin="9" background='<%=path %>/images/allbg.gif'>
			<form action="<%=path %>/wenzhangEdit.action" name="formAdd" method="post" enctype="multipart/form-data">
   ...
   <s:iterator value="#request.leibiesl" id="data">
	   <option value='<s:property value="#data.id"/>'><s:property value="#data.mingcheng"/></option>
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="mingcheng" style="width: 200px;" value="${requestScope.wenzhang.mingcheng }"/>
						    </td>
						</tr>
...
内容:
						    ...
						    <td width="85%" bgcolor="#FFFFFF" align="left">
						      <textarea name="jieshao" id="jieshao" >${requestScope.wenzhang.jieshao }</textarea>
...
UE.getEditor('jieshao',{toolbars:[['FullScreen', 'Source','Undo', 'Redo','Bold','test']],wordCount:false,elementPathEnabled:false,
            initialFrameHeight:100,initialFrameWidth:340})   </script>
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="fujian" id="fujian" style="width: 200px;" value="${requestScope.wenzhang.fujian }" readonly="readonly"/>
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						       <input type="hidden" name="id" value="${requestScope.wenzhang.id }"/>
