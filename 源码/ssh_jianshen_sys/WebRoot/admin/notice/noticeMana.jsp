...
<script language="JavaScript" src="<%=path %>/js/public.js" type="text/javascript"></script>
		...
		<script type="text/javascript">
	       function go(index)
           {
               window.location.href="<%=path %>/noticeMana.action?index="+index;
           }
</script>
</head>
<table width="96%"  border="0" align="center" cellpadding="4" cellspacing="1" >
 ...
 <tr align="center" bgcolor="#F2FDFF"><td class="optiontitle">序号</td><td class="optiontitle">标题</td>
	<td class="optiontitle">内容</td>
	<td class="optiontitle">操作</td></tr><c:forEach items="${requestScope.page.data}" var="notice"  varStatus="ss"><tr align="center" bgcolor="#FFFFFF" onmouseover='this.style.background="#F2FDFF"' onmouseout='this.style.background="#FFFFFF"'><td bgcolor="#FFFFFF" align="center">${ss.index+1 + (requestScope.page.index*4-4)}</td><td height="25">${notice.title}</td><td height="25">${notice.neirong}</td><td height="25"> <a href="noticeDel.action?id=${notice.id}" onClick="return confirm('您确定要删除吗?')">删除</a></td></tr>
