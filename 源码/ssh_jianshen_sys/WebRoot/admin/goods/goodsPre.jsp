	...
	<body leftmargin="2" topmargin="9" background='<%=path %>/images/allbg.gif'>
		...
		<form action="<%=path %>/goodsEdit.action" name="formAdd" method="post" enctype="multipart/form-data">
				     <table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
						<tr bgcolor="#EEF4EA">
					        <td colspan="3" background="<%=path %>/images/wbg.gif" class='title'><span>添加商品</span></td>
					    </tr>
   ...
   <s:iterator value="#request.cateLogsl" id="data">
	   <option value="<s:property value="#data.catelogId"/>"><s:property value="#data.catelogName"/></option>
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="goodsName" size="50" value="${requestScope.goods.goodsName }"/>
						    </td>
						</tr>
...
内容:
						    ...
						    <td width="85%" bgcolor="#FFFFFF" align="left">
						      <textarea name="goodsMiaoshu" id="goodsMiaoshu" >${requestScope.goods.goodsMiaoshu }</textarea>
...
UE.getEditor('goodsMiaoshu',{toolbars:[['FullScreen', 'Source','Undo', 'Redo','Bold','test']],wordCount:false,elementPathEnabled:false,
            initialFrameHeight:100,initialFrameWidth:340})   </script>
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="fujian" id="fujian" value="${requestScope.goods.goodsPic }"  size="30" readonly="readonly"/>
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="goodsShichangjia"  value="${requestScope.goods.goodsShichangjia }" size="20" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
						    </td>
						</tr>
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						    						       <input type="hidden" name="id"  value="${requestScope.goods.goodsId }"/>
