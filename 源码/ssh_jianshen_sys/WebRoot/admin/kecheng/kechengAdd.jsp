...
<form name="formAdd" method="post" action="<%=path %>/kechengAdd.action" ><table width="96%"  border="0" align="center" cellpadding="4" cellspacing="1" >
 <tr><th height="29" align="center">添加</th></tr></table><table width="96%"  border="0" align="center" cellpadding="4" cellspacing="1" ><tr align="center">
 ...
 <script type="text/javascript" src="<%=path %>/ueditor/ueditor.config.js"></script>
       <script type="text/javascript" src="<%=path %>/ueditor/ueditor.all.js"></script><tr align="center" bgcolor="#FFFFFF" >
						    ...
						    <td width="85%" bgcolor="#FFFFFF" align="left">
						      <textarea name="jieshao" id="jieshao" ></textarea>
	                            <script type="text/javascript">
...
<td align="left"><input name="jiaolian" type="text" id="jiaolian" size="20" ></td>
</tr>
<tr align="center">
