...
<table width="96%"  border="0" align="center" cellpadding="4" cellspacing="1" >
 <tr><th height="29" align="center">列表</th></tr></table>
...
<c:forEach items="${requestScope.page.data}" var="kecheng"  varStatus="ss">
...
<td height="25"><a href="<%=path %>/kechengEditPre.action?id=${kecheng.id}">修改</a>| <a href="kechengDel.action?id=${kecheng.id}" onClick="return confirm('您确定要删除吗?')">删除</a></td>
</tr>
